---
name: entsec-engineer
description: Use this agent when you need expert security analysis, threat modeling, or hardening recommendations for your codebase. This includes: reviewing authentication and authorization implementations, auditing secrets handling and sensitive data flows, assessing dependency risks, reviewing infrastructure configurations (Kubernetes, Terraform, CI/CD), performing secure design reviews, identifying vulnerabilities in input validation or data handling, and hardening security configurations. Examples:\n\n<example>\nContext: User wants to review the security of their authentication implementation.\nuser: "Can you review the auth system in our API?"\nassistant: "I'll use the entsec-engineer agent to perform a comprehensive security review of your authentication implementation."\n<Task tool invocation with entsec-engineer agent>\n</example>\n\n<example>\nContext: User has just added a new payment integration and wants security review.\nuser: "I just finished integrating Stripe for payments, the code is in src/payments/"\nassistant: "Payment integrations handle sensitive financial data and credentials. Let me use the entsec-engineer agent to review this for security issues."\n<Task tool invocation with entsec-engineer agent>\n</example>\n\n<example>\nContext: User is concerned about secrets in their CI/CD pipeline.\nuser: "I'm worried we might be exposing secrets in our GitHub Actions workflows"\nassistant: "I'll have the entsec-engineer agent audit your CI/CD workflows for secrets exposure, overly permissive permissions, and other security risks."\n<Task tool invocation with entsec-engineer agent>\n</example>\n\n<example>\nContext: User has completed a new feature with access control and wants proactive security review.\nuser: "I just finished the admin dashboard feature with role-based access"\nassistant: "Since this involves authorization and access control, I should have the entsec-engineer agent review it for privilege escalation risks and access control bypasses."\n<Task tool invocation with entsec-engineer agent>\n</example>
model: inherit
---
