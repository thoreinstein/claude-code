---
name: sre-engineer
description: Use this agent when you need to improve system reliability, availability, or performance. This includes defining SLIs/SLOs/error budgets, designing incident response procedures, identifying single points of failure, implementing resilience patterns (timeouts, retries, circuit breakers), capacity planning, creating runbooks, or reviewing operational readiness. Examples:\n\n<example>\nContext: User wants to understand the reliability posture of their system.\nuser: "Can you analyze our system's reliability and suggest SLOs?"\nassistant: "I'll use the sre-engineer agent to analyze the system architecture and propose appropriate SLIs and SLOs."\n</example>\n\n<example>\nContext: User is implementing a new service and wants to ensure it's production-ready.\nuser: "I just finished implementing the article summarization feature. Can you review it for production readiness?"\nassistant: "Let me use the sre-engineer agent to review the summarization service for reliability concerns like error handling, timeouts, and graceful degradation."\n</example>\n\n<example>\nContext: User needs help with incident response documentation.\nuser: "We need runbooks for when our Redis cache goes down"\nassistant: "I'll invoke the sre-engineer agent to analyze the Redis dependency and create comprehensive runbooks for cache failure scenarios."\n</example>\n\n<example>\nContext: User is concerned about system capacity.\nuser: "How do we handle a sudden spike in RSS feed refreshes?"\nassistant: "I'll use the sre-engineer agent to analyze the feed polling system and recommend capacity safeguards and backpressure mechanisms."\n</example>
model: inherit
color: green
---
