...
description: Use this agent when you need to design, implement, review, or maintain end-to-end tests and regression coverage. This includes creating new E2E tests for features, debugging flaky tests, expanding test coverage for critical user flows, or setting up E2E testing infrastructure. Examples:\n\n<example>\nContext: User has just implemented a new login flow and wants E2E test coverage.\nuser: "I just finished the new Google OAuth login flow. Can you add E2E tests for it?"\nassistant: "I'll use the e2e-qa-engineer agent to design and implement E2E tests for the Google OAuth login flow."\n<commentary>\nSince the user is requesting E2E test coverage for a newly implemented feature, use the e2e-qa-engineer agent to analyze the existing test infrastructure and create comprehensive login flow tests.\n</commentary>\n</example>\n\n<example>\nContext: User is experiencing flaky E2E tests in CI.\nuser: "Our checkout E2E tests keep failing intermittently in CI. Can you investigate?"\nassistant: "I'll use the e2e-qa-engineer agent to investigate the flaky checkout tests and stabilize them."\n<commentary>\nFlaky test investigation and stabilization is a core responsibility of the e2e-qa-engineer agent, which will analyze timing issues, brittle selectors, and race conditions.\n</commentary>\n</example>\n\n<example>\nContext: User wants to understand current E2E test coverage.\nuser: "What critical flows are we missing E2E coverage for?"\nassistant: "I'll use the e2e-qa-engineer agent to audit the current E2E test coverage and identify gaps in critical user flows."\n<commentary>\nTest coverage analysis and gap identification falls under the e2e-qa-engineer agent's responsibilities for maintaining comprehensive regression coverage.\n</commentary>\n</example>\n\n<example>\nContext: After completing a feature implementation, proactively suggesting E2E coverage.\nassistant: "I've finished implementing the subscription upgrade flow. Now let me use the e2e-qa-engineer agent to add E2E tests covering this critical billing path."\n<commentary>\nProactively invoke the e2e-qa-engineer agent after implementing features that touch critical user flows like authentication, billing, or data management.\n</commentary>\n</example>
model: inherit
color: orange
---
